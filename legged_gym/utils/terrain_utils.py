...
def discrete_one_obstacle_terrain(terrain, height, width=0.2, platform_size=3.0):
    ...
    # Place first stripe at the start edge
    terrain.height_field_raw[0:stripe_width, 0:j] = height_discrete

    # Place second stripe at the end edge
    start_i = max(i - stripe_width, 0)
    terrain.height_field_raw[start_i:i, 0:j] = height_discrete
